...
<body>
	...
	<a href="<%=request.getContextPath()%>/Controller?action=createRelease"
	...
	<div class="row">
		<div class="col-lg-12">
			<h3 class="page-header">
				<i class="fa fa-files-o"></i>Release Creation
			</h3>
			<ol class="breadcrumb">
				<li><i class="fa fa-home"></i>Home</li>
				<li><i class="icon_document_alt"></i>Releases</li>
				<li><i class="fa fa-files-o"></i>Create Releases</li>
			</ol>
		</div>
	</div>
	<!-- Form validations -->
				...
				<div class="form">
					<form class="form-validate form-horizontal" id="feedback_form"
						...
						<div class="form-group ">
							<label for="cname" class="control-label col-lg-2">Release
								Goals<span class="required">*</span>
							</label>
							<div class="col-lg-10">
								<textarea name="goals" rows=10 cols=30 / class="form-control"></textarea>
							</div>
						...
						<div class="form-group ">
							...
							<div class="col-lg-10">
								<textarea name="comments" rows=10 cols=30 / class="form-control"></textarea>
							</div>
						...
						<div class="form-group ">
							<label for="ccomment" class="control-label col-lg-2">End
								Date</label>
							<div class="col-lg-10">
								<input type="date" id="start" name="enddate" value="2018-07-22"
						...
						<div class="form-group">
							<div class="col-lg-offset-2 col-lg-10">
								<button class="btn btn-primary" type="submit"
									formaction="<%=request.getContextPath()%>/Controller?action=createRelease&username=<%=session.getAttribute("usernamedisplay")%>">Save</button>
