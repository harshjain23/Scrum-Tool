...
<body>
	...
	<a href="<%=request.getContextPath()%>/Controller?action=createFeature"
	...
	<div class="row">
		<div class="col-lg-12">
			<h3 class="page-header">
				<i class="fa fa-files-o"></i>Feature Creation
			</h3>
			<ol class="breadcrumb">
				<li><i class="fa fa-home"></i>Home</li>
				<li><i class="icon_document_alt"></i>Features</li>
				<li><i class="fa fa-files-o"></i>Create Features</li>
			</ol>
		</div>
	</div>
	<!-- Form validations -->
			...
			<div class="panel-body">
				<div class="form">
					<form class="form-validate form-horizontal" id="feedback_form"
						method="post" action="createFeature">
						...
						<div class="form-group">
							<div class="col-lg-offset-2 col-lg-10">
								<button class="btn btn-primary" type="submit"
									formaction="<%=request.getContextPath()%>/Controller?action=createFeature
